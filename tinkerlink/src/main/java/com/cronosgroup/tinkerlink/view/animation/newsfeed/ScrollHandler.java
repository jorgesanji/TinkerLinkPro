package com.cronosgroup.tinkerlink.view.animation.newsfeed;
...
public class ScrollHandler extends RecyclerView.OnScrollListener {
    ...
    public ScrollHandler(TLMenuButton bottomView, View topView, View middleView) {
        this.bottomView = bottomView;
        this.topView = topView;
        this.middleView = middleView;
    }

    private TLMenuButton bottomView;
    ...
    public void setBottomView(TLMenuButton bottomView) {
        this.bottomView = bottomView;
    }
