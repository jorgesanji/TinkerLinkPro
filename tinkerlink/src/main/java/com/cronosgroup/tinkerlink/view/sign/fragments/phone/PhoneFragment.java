...
public class PhoneFragment extends MVPTinkerLinkFragment<PhonePresenter, PhonePresenter.View>
    ...
    protected void onDidAppear() {
        RestCountry restCountry = appCountryManager.getCurrentCountry();
    ...
    private void setCountry(RestCountry restCountry) {
        String countryName = appCountryManager.getCurrentNameFromLocale(appCountryManager.getCurrentCountry());
