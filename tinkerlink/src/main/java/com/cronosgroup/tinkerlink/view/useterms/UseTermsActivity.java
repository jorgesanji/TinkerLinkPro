 ...
 */
public class UseTermsActivity extends TinkerLinkActivity<UseTermsFragment> {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setIconAndBackButton();
        setTitle(R.string.sign_phone_use_terms_title);
    }

    @Override
    public Class<UseTermsFragment> getFragment() {
        return UseTermsFragment.class;
    }
