 ...
 */
public class UserStatusActivity extends TinkerLinkActivity<UserStatusFragment> {
    ...
    @Override
    public Class<UserStatusFragment> getFragment() {
        return UserStatusFragment.class;
    }
